...
export const deepDiff = function diff(origin, comparand) {
...
/*
  let dummyMongoConnection = mongoose.createConnection('mongodb://localhost/myapp', options, function (err, db) {

  });
  dummyMongoConnection.on('error',function (err) {
    //console.log(err);
  });
*/
